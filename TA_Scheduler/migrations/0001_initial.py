    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_people', models.ManyToManyField(blank=True, to='TA_Scheduler.account')),
            ],
        ),
        migrations.CreateModel(
            name='UsAddress',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='TA_Scheduler.account')),
